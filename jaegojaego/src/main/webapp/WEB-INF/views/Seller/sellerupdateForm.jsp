...
<body>
   ...
   <h1 class="page-title">
      회원 수정 : <span class="fw-semi-bold">판매자</span>
   </h1>
   <div class="row">
      <div class="col-md-6">
         <section class="widget">
            ...
            <div class="widget-body">
               <form method="post" id="sellerupdateForm"
                  enctype="multipart/form-data" class="form-horizontal" role="form"
                  action="sellerupdateForm">
                  <fieldset>
                     <legend>
                        <strong> <%--Horizontal--%>
                        </strong>
                     ...
                     <div class="form-group">
                        <label for="normal-field" class="col-sm-4 control-label">사업자
                           번호</label>
                        <div class="col-sm-7">
                           <input type="text" name="sellerCRN" id="sellerCRN"
                              class="form-control" readonly="readonly"
                              value="${seller.sellerCRN}">
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-7">
                           <div class="input-group">
                              ...
                              <input type="text" name="sellerId_tf" id="sellerId_tf"
                                 class="form-control" size="16" disabled="disabled"
                                 readonly="readonly" value="${seller.sellerId}"> <input
                                 type="hidden" name="sellerId" id="sellerId" value="${seller.sellerId}">
                           </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-7">
                           <div class="input-group">
                              ...
                              <input type="password" class="form-control" name="sellerPw"
                                 id="sellerPw" placeholder='영문 or 숫자 6자 이상'>
                           </div>
                        </div>
                     </div>
                     <div class="form-group">
                        ...
                        <div class="col-sm-7">
                           <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                              <input type="password" class="form-control" id="sellerPw2"
                     ...
                     <div class="form-group">
                        <label for="hint-field" class="col-sm-4 control-label">
                           대표자 성명 <%--<span class="help-block">Some help text</span>--%>
                        </label>
                        <div class="col-sm-7">
                           <input type="text" name="sellerName" id="sellerName"
                              class="form-control" placeholder='대표자 성명'
                              >
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        <label for="hint-field" class="col-sm-4 control-label">
                           상호 <%--<span class="help-block">Some help text</span>--%>
                        </label>
                        <div class="col-sm-7">
                           <input type="text" name="sellerShopName" id="sellerShopName"
                              class="form-control" readonly="readonly"
                              value="${seller.sellerShopName}">
                        </div>
                     </div>

                     <div class="form-group">
                        <label for="hint-field" class="col-sm-4 control-label">
                           전화번호 <%--<span class="help-block">-를 제외한 번호만 입력하세요</span>--%>
                        </label>
                        <div class="col-sm-7">
                           <input type="text" name="sellerPhone" id="sellerPhone"
                              class="form-control" placeholder='-를 제외한 번호만 입력하세요'>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        <label class="col-sm-4 control-label" for="disabled-input">매장
                           주소</label>
                        <div class="col-sm-7">
                           <input type="text" id="sellerBEA_tf<%--disabled-input--%>"
                              name="sellerBEA_tf" class="form-control" disabled="disabled" readonly="readonly" value="${seller.sellerBEA}">
               ...
               <%--             ------------------------------------------------------------------------------------------------------------------------------------------------------------------
                           ...
                           <%----------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
                           <input type="hidden" name="sellerLat" id="sellerLat" value="${seller.sellerLat}"> <input
                              type="hidden" name="sellerLong" id="sellerLong" value="${seller.sellerLong}"><br>
                        </div>
                     </div>
