...
<html>
<head>
    <title>Sing - Tables Dynami</title>
        ...
        <ul class="sidebar-nav">
            <li>
                ...
                <ul id="sidebar-dashboard" class="collapse in">
                    <li><a href="goodsanalysis">그래프 1 (goodsanalysis)</a></li>
                    <li><a href="goodsanalysis2">그래프 2 (goodsanalysis2)</a></li>
                    <li class="active"><a href="goodsanalysis3">그래프 3 (goodsanalysis3)</a></li>
                    <li><a href="goodsanalysis4">그래프 3 (goodsanalysis4)</a></li>
                </ul>
            </li>
...
<div class="content-wrap">
	<main id="content" class="content" role="main">
		...
		<h1 class="page-title">그래프 : <span class="fw-semi-bold">판매자</span></h1>
