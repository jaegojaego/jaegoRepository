...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
        ...
        <!--</ol>-->
        <!--<h1 class="page-title">Widgets - <span class="fw-semi-bold">Options</span></h1>-->
                ...
                <section class="widget">
                    ...
                    <div class="widget-body">
                        <div class="widget-top-overflow windget-padding-md clearfix bg-warning text-white">
                            <h3 class="mt-lg mb-lg">커피</h3><br>
                        <p class="text-light fs-mini m">업종 : 카페</p>
                        <p class="text-light fs-mini m">주소 : 서울시 강남구 삼성동</p>
                        <p class="text-light fs-mini m">전번 : 02-123-4567</p>
