			...
			<div id="holder"></div><%--록--%>                        
				...
				<input type="hidden" id="goodsStatus" value="off"><%--록--%>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" rows="4" class="form-control" <%--id="default-textarea"--%> id="goodsName" name="goodsName">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" rows="4" class="form-control" <%--id="default-textarea"--%> id="goodsPrice" name="goodsPrice">
                                    </div>
                                </div>
