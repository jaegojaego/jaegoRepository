...
<main class="site__content island" role="content">
  ...
  <div class="wrap">
    <form>
      <button class="butt2" style="background-color: white;"><a href="SellerLoginForm" class="jeju" style="text-decoration: none;">seller</a></button>
      <button class="butt2" style="background-color: white;"><a href="BuyerLoginForm" class="jeju" style="text-decoration: none;">buyer</a></button>
    </form> 
