                    ...
                    $.ajax({//type필수임
                        ...
                        success : function(data){
                           ...
                           var content = '<div class="wrap">' + 
                            ...
                            '      </div> <div class="shopinfo" width="180">가게설명:'+position.shopaddress+'<br><h3>관심매장추가</h3><img src="./resources/image/picture.png" width="20px" height="20px" class="addshop"></div></div>' + 
                            '      <div class="desc">' + 
                            ...
                            '           </div>' + 
                            '        <댓글목록><div id="bnt">abc</div><input type="button" id="abcd" value="바뀌어라"></div>' + 
...
<style>
    ...
    .wrap .info {width: 303px;height: 500px;border-radius: 5px;border-bottom: 2px solid #ccc;border-right: 1px solid #ccc;overflow: hidden;background: red;}
    .wrap .info:nth-child(1) {border: 0;box-shadow: 0px 1px 2px #888;}
    .info .title {padding: 5px 0 0 10px;height: 30px;background: #eee;border-bottom: 1px solid #ddd;font-size: 18px;font-weight: bold;}
    .info .close {position: absolute;top: 10px;right: 10px;color: #888;width: 17px;height: 17px;background: url('http://t1.daumcdn.net/localimg/localimages/07/mapapidoc/overlay_close.png');}
    .info .close:hover {cursor: pointer;}
    .info .body {position: relative;overflow: hidden;background:gray;}
